# systems.builtin.deterministic.continuous.Lorenz { #cdesym.systems.builtin.deterministic.continuous.Lorenz }

```python
systems.builtin.deterministic.continuous.Lorenz(*args, **kwargs)
```
