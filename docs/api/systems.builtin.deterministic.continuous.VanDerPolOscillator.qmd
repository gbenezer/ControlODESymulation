# systems.builtin.deterministic.continuous.VanDerPolOscillator { #cdesym.systems.builtin.deterministic.continuous.VanDerPolOscillator }

```python
systems.builtin.deterministic.continuous.VanDerPolOscillator(*args, **kwargs)
```
