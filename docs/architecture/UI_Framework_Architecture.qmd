...
## Layer Breakdown {#sec-layer-breakdown}

### Layer 0: Foundation - SymbolicSystemBase {#sec-layer-0-foundation---symbolicsystembase}
...
### Layer 1: Time-Domain Bases {#sec-layer-1-time-domain-bases}

#### ContinuousSystemBase {#sec-continuoussystembase}
...
#### DiscreteSystemBase   {#sec-discretesystembase--}
...
### Layer 2: Concrete Symbolic Implementations {#sec-layer-2-concrete-symbolic-implementations}

#### ContinuousSymbolicSystem {#sec-continuoussymbolicsystem}
...
#### DiscreteSymbolicSystem {#sec-discretesymbolicsystem}
...
### Layer 3: Stochastic Extensions {#sec-layer-3-stochastic-extensions}

#### ContinuousStochasticSystem {#sec-continuousstochasticsystem}
...
#### DiscreteStochasticSystem {#sec-discretestochasticsystem}
...
### Special System: DiscretizedSystem {#sec-special-system-discretizedsystem}
...
### 5. Zero Code Duplication {#sec-5-zero-code-duplication}
...
## Key Abstractions {#sec-key-abstractions}

### Abstract Methods Users Must Implement {#sec-abstract-methods-users-must-implement}
...
### System Properties (Automatic) {#sec-system-properties-automatic}
...
### Continuous Systems (via IntegratorFactory) {#sec-continuous-systems-via-integratorfactory}
...
### Stochastic Systems (via SDEIntegratorFactory) {#sec-stochastic-systems-via-sdeintegratorfactory}
...
### Continuous Deterministic System {#sec-continuous-deterministic-system}
```{python}
#| output: false
...
### Discrete System {#sec-discrete-system}
```{python}
#| output: false
...
### Stochastic System (SDE) {#sec-stochastic-system-sde}
```{python}
#| output: false
...
## Strengths of This Architecture {#sec-strengths-of-this-architecture}
