...
### Example 2: GPU-Accelerated Neural ODE (PyTorch) {#sec-example-2-gpu-accelerated-neural-ode-pytorch}
```{python}
#| output: false
import torch
from src.systems.base.numerical_integration import IntegratorFactory
...
### Example 3: High-Accuracy Julia Integration {#sec-example-3-high-accuracy-julia-integration}
```{python}
#| output: false
from src.systems.base.numerical_integration import IntegratorFactory
...
### Example 4: Stochastic SDE Integration {#sec-example-4-stochastic-sde-integration}
```{python}
#| output: false
...
### Example 5: Monte Carlo SDE Simulation {#sec-example-5-monte-carlo-sde-simulation}
```{python}
#| output: false
...
### Example 6: Custom Noise (Deterministic Testing) {#sec-example-6-custom-noise-deterministic-testing}
```{python}
#| output: false
