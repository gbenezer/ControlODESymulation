...
## Core Utilities {#sec-core-utilities}
...
### Pattern 1: Backend Switching {#sec-pattern-1-backend-switching}
...
### Pattern 2: Performance Profiling {#sec-pattern-2-performance-profiling}
...
### Pattern 3: Compilation and Warmup {#sec-pattern-3-compilation-and-warmup}
...
### Pattern 4: Equilibrium Management {#sec-pattern-4-equilibrium-management}
...
### Pattern 5: Stochastic Noise Analysis {#sec-pattern-5-stochastic-noise-analysis}
...
### Issue: "Parameter keys must be Symbol, not str" {#sec-issue-parameter-keys-must-be-symbol-not-str}
...
### Issue: Slow first call, fast subsequent calls {#sec-issue-slow-first-call-fast-subsequent-calls}
...
### Issue: Backend mismatch errors {#sec-issue-backend-mismatch-errors}
...
### Issue: Equilibrium verification fails {#sec-issue-equilibrium-verification-fails}
...
### Custom Backend Configuration {#sec-custom-backend-configuration}
...
### Symbolic Jacobian Analysis {#sec-symbolic-jacobian-analysis}
...
### Cache Management {#sec-cache-management}
...
## Testing Your Utilities {#sec-testing-your-utilities}
