...
subtitle: "ControlDESymulation Quick Reference Guides"
author: "Gil Benezer"
date: today
format:
  html:
...
### 1. Time-Domain Trajectory Plot {#sec-1-time-domain-trajectory-plot}
...
### 2. Phase Portrait (2D) {#sec-2-phase-portrait-2d}
...
### 3. Control Analysis (Eigenvalue Map) {#sec-3-control-analysis-eigenvalue-map}
...
### 4. State and Control Together {#sec-4-state-and-control-together}
...
## Trajectory Plotting {#sec-trajectory-plotting}

### Basic Trajectory Plot {#sec-basic-trajectory-plot}
...
### Batched Trajectories (Monte Carlo) {#sec-batched-trajectories-monte-carlo}
...
### State and Control Combined {#sec-state-and-control-combined}
...
### Comparing Multiple Runs {#sec-comparing-multiple-runs}
...
## Phase Portrait Plotting {#sec-phase-portrait-plotting}

### 2D Phase Portrait {#sec-2d-phase-portrait}
...
### With Direction Arrows {#sec-with-direction-arrows}
...
### With Vector Field {#sec-with-vector-field}
...
### With Equilibria {#sec-with-equilibria}
...
### 3D Phase Portrait {#sec-3d-phase-portrait}
...
### Limit Cycle Visualization {#sec-limit-cycle-visualization}
...
## Control Analysis Plots {#sec-control-analysis-plots}
...
### Riccati Convergence {#sec-riccati-convergence}
...
### Controllability Gramian {#sec-controllability-gramian}
...
### Observability Gramian {#sec-observability-gramian}
...
### Impulse Response {#sec-impulse-response}
...
### Nyquist Diagram {#sec-nyquist-diagram}
...
## Theming and Customization {#sec-theming-and-customization}

### Available Themes {#sec-available-themes}
...
### Available Color Schemes {#sec-available-color-schemes}
...
### Color Utilities {#sec-color-utilities}
...
## Common Patterns {#sec-common-patterns}

### Pattern 1: Publication-Ready Figure {#sec-pattern-1-publication-ready-figure}
...
### Pattern 2: Multi-Subplot Analysis {#sec-pattern-2-multi-subplot-analysis}
...
### Pattern 3: Batch Visualization {#sec-pattern-3-batch-visualization}
...
### Pattern 4: Interactive Dashboard {#sec-pattern-4-interactive-dashboard}
...
### Pattern 5: Animation (Time Evolution) {#sec-pattern-5-animation-time-evolution}
...
### Pattern 6: Backend-Agnostic Plotting {#sec-pattern-6-backend-agnostic-plotting}
...
### Issue: Plot appears blank {#sec-issue-plot-appears-blank}
...
### Issue: Theme not applying {#sec-issue-theme-not-applying}
...
### Issue: Batched data not showing std bands {#sec-issue-batched-data-not-showing-std-bands}
...
### Issue: Colors cycling too fast {#sec-issue-colors-cycling-too-fast}
...
### Issue: 3D plot not interactive {#sec-issue-3d-plot-not-interactive}
...
### Issue: Export to PDF fails {#sec-issue-export-to-pdf-fails}
...
## Direct Plotter Usage (Without System) {#sec-direct-plotter-usage-without-system}
...
### Custom Color Scheme {#sec-custom-color-scheme}
...
### Subplot Customization {#sec-subplot-customization}
...
### 1. Always Use Themes for Consistency {#sec-1-always-use-themes-for-consistency}
...
### 2. Use Colorblind-Safe Palettes {#sec-2-use-colorblind-safe-palettes}
...
### 3. Add Informative Labels {#sec-3-add-informative-labels}
...
### 4. Export Multiple Formats {#sec-4-export-multiple-formats}
