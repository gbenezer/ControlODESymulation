...
### 1. Automatic Integration (Easiest) {#sec-1-automatic-integration-easiest}
...
### 2. Specific Method Selection {#sec-2-specific-method-selection}
...
### 3. Use Case Helpers {#sec-3-use-case-helpers}
...
## Available Methods {#sec-available-methods}

### NumPy (scipy) {#sec-numpy-scipy}
...
### NumPy (Julia via DiffEqPy) {#sec-numpy-julia-via-diffeqpy}
...
### PyTorch (torchdiffeq) {#sec-pytorch-torchdiffeq}
...
### Manual (Fixed-Step) {#sec-manual-fixed-step}
...
## Stochastic SDE Integration {#sec-stochastic-sde-integration}

### Create SDE Integrator {#sec-create-sde-integrator}
...
### Single Trajectory {#sec-single-trajectory}
...
### Monte Carlo Simulation {#sec-monte-carlo-simulation}
...
### Custom Noise (Deterministic Testing) {#sec-custom-noise-deterministic-testing}
...
### Pattern 1: GPU Acceleration (PyTorch) {#sec-pattern-1-gpu-acceleration-pytorch}
...
### Pattern 2: High Accuracy {#sec-pattern-2-high-accuracy}
...
### Pattern 3: Stiff Systems {#sec-pattern-3-stiff-systems}
...
### Pattern 4: Dense Output (Interpolation) {#sec-pattern-4-dense-output-interpolation}
...
### Pattern 5: Specific Time Points {#sec-pattern-5-specific-time-points}
...
### Pattern 6: Controlled vs Autonomous Systems {#sec-pattern-6-controlled-vs-autonomous-systems}
...
### Pattern 7: Time-Varying Control {#sec-pattern-7-time-varying-control}
...
### Pattern 8: Neural ODE Training {#sec-pattern-8-neural-ode-training}
...
### By System Type {#sec-by-system-type}
...
## Integration Result Fields {#sec-integration-result-fields}

### ODE Integration {#sec-ode-integration}
```{python}
result = {
...
### SDE Integration {#sec-sde-integration}
```{python}
result = {
    # All ODE fields, plus:
...
### Issue: Integration fails with "maximum steps exceeded" {#sec-issue-integration-fails-with-maximum-steps-exceeded}
...
### Issue: Integration too slow {#sec-issue-integration-too-slow}
...
### Issue: Integration not accurate enough {#sec-issue-integration-not-accurate-enough}
...
### Issue: SDE results vary too much {#sec-issue-sde-results-vary-too-much}
...
### Issue: Out of memory (GPU) {#sec-issue-out-of-memory-gpu}
...
### Event Detection (scipy only) {#sec-event-detection-scipy-only}
...
### Custom Integration Options {#sec-custom-integration-options}
...
## Testing Your Integration {#sec-testing-your-integration}
