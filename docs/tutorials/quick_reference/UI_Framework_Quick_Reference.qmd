...
## Quick Start Guide {#sec-quick-start-guide}

### 1. Continuous Deterministic System {#sec-1-continuous-deterministic-system}
...
### 2. Discrete System {#sec-2-discrete-system}
...
### 3. Stochastic System (SDE) {#sec-3-stochastic-system-sde}
...
### 4. Higher-Order Systems {#sec-4-higher-order-systems}
...
## Common Operations {#sec-common-operations}

### Backend Management {#sec-backend-management}
...
### Equilibrium Management {#sec-equilibrium-management}
...
### Configuration Persistence {#sec-configuration-persistence}
...
### Performance Statistics {#sec-performance-statistics}
...
### Code Compilation {#sec-code-compilation}
...
### Pattern 1: Parameter Study {#sec-pattern-1-parameter-study}
...
### Pattern 2: Closed-Loop Control {#sec-pattern-2-closed-loop-control}
...
### Pattern 3: Batch Evaluation {#sec-pattern-3-batch-evaluation}
...
### Pattern 4: Multi-Backend Comparison {#sec-pattern-4-multi-backend-comparison}
...
### Issue: "System must define self._dt" {#sec-issue-system-must-define-selfdt}

**Solution:** For discrete systems, add `self._dt = dt` in `define_system()`

### Issue: "diffusion_expr is None" {#sec-issue-diffusionexpr-is-none}

**Solution:** For stochastic systems, add `self.diffusion_expr = sp.Matrix([...])` in `define_system()`

### Issue: NumPy boolean comparison warning {#sec-issue-numpy-boolean-comparison-warning}

**Solution:** This is handled internally. If you see it, ensure you're using the latest version.

### Issue: Integration fails {#sec-issue-integration-fails}
...
### Issue: Linearization returns NaN {#sec-issue-linearization-returns-nan}
...
## Testing Your System {#sec-testing-your-system}
...
### Custom Output Functions {#sec-custom-output-functions}
...
### Time-Varying Parameters {#sec-time-varying-parameters}
...
### Hybrid Systems {#sec-hybrid-systems}
