...
### 1. LQR Controller Design {#sec-1-lqr-controller-design}
...
### 2. Kalman Filter Design {#sec-2-kalman-filter-design}
...
### 3. LQG Controller Design {#sec-3-lqg-controller-design}
...
### 4. System Analysis {#sec-4-system-analysis}
...
## Control Design Methods {#sec-control-design-methods}

### LQR Controller {#sec-lqr-controller}
...
### LQG Controller {#sec-lqg-controller}
...
## System Analysis Methods {#sec-system-analysis-methods}
...
### Controllability Analysis {#sec-controllability-analysis}
...
### Observability Analysis {#sec-observability-analysis}
...
### Pattern 1: Full State Feedback LQR {#sec-pattern-1-full-state-feedback-lqr}
...
### Pattern 2: Observer-Based Control {#sec-pattern-2-observer-based-control}
...
### Pattern 3: LQG Controller {#sec-pattern-3-lqg-controller}
...
### Pattern 4: Discrete-Time Control {#sec-pattern-4-discrete-time-control}
...
### Pattern 5: Tuning LQR Weights {#sec-pattern-5-tuning-lqr-weights}
...
### Pattern 6: Pre-Flight Checks {#sec-pattern-6-pre-flight-checks}
...
### Pattern 7: Multi-Backend Support {#sec-pattern-7-multi-backend-support}
...
### Issue: LQR design fails with "No stabilizing solution" {#sec-issue-lqr-design-fails-with-no-stabilizing-solution}
...
### Issue: Kalman filter design fails {#sec-issue-kalman-filter-design-fails}
...
### Issue: Closed-loop unstable despite LQR design {#sec-issue-closed-loop-unstable-despite-lqr-design}
...
### Issue: LQG eigenvalues don't match individual designs {#sec-issue-lqg-eigenvalues-dont-match-individual-designs}
...
## Direct Function Usage (Advanced) {#sec-direct-function-usage-advanced}
...
## Testing Your Controller {#sec-testing-your-controller}
