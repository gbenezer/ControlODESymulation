...
class DiscretizedSystem(DiscreteSystemBase):
    ...
    def _step_fixed(self, x, u, t_start, t_end):
        ...
        **Warning**: When fallback occurs, noise is IGNORED and only drift term
        ...
        use_sde = (
            self._is_stochastic and self._method in self._SDE_METHODS and self._has_sde_integrator
        )
    ...
    def get_info(self) -> dict:
        ...
        if self.is_stochastic:
            stochastic_info = {
                ...
                "noise_ignored": self._method in self._DETERMINISTIC_FIXED_STEP
                and not self._has_sde_integrator,
            }
