...
Design Note
-----------
This module uses semantic types from controldesymulation.types.core for time step parameters,
...
from cdesym.types.backends import Backend, IntegrationMethod
...
class IntegratorFactory:
    ...
    def _create_torch_integrator(
        ...
        **options,
        ...
        from cdesym.systems.base.numerical_integration.torchdiffeq_integrator import (
