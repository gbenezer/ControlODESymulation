...
class TestBackendDefaults:
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_numpy_default(self, mock_integrator, controlled_sde_system):
        """Test NumPy backend defaults to Julia EM."""
        mock_integrator.return_value = MockSDEIntegrator(controlled_sde_system)
        ...
        call_kwargs = mock_integrator.call_args[1]
        assert call_kwargs['algorithm'] == 'EM'
        assert call_kwargs['backend'] == 'numpy'
    
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.TorchSDEIntegrator')
    def test_torch_default(self, mock_integrator, controlled_sde_system):
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffraxSDEIntegrator')
    def test_jax_default(self, mock_integrator, controlled_sde_system):
...
class TestMethodRouting:
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_julia_method_routes_to_numpy(self, mock_integrator, controlled_sde_system):
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.TorchSDEIntegrator')
    def test_torchsde_method_routes_to_torch(self, mock_integrator, controlled_sde_system):
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffraxSDEIntegrator')
    def test_diffrax_method_routes_to_jax(self, mock_integrator, controlled_sde_system):
...
class TestControlledSystemIntegration:
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_controlled_system_creation(self, mock_integrator, controlled_sde_system):
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_controlled_integration_with_feedback(self, mock_integrator, controlled_sde_system):
        """Test integration with state feedback control."""
        integrator = MockSDEIntegrator(controlled_sde_system, backend='numpy')
        mock_integrator.return_value = integrator
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_controlled_integration_constant_control(self, mock_integrator, controlled_sde_system):
...
class TestAutonomousSystemIntegration:
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_autonomous_system_creation(self, mock_integrator, autonomous_sde_system):
        """Test factory creates integrator for autonomous system."""
        mock_integrator.return_value = MockSDEIntegrator(autonomous_sde_system)
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_autonomous_integration_with_none_control(self, mock_integrator, autonomous_sde_system):
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.TorchSDEIntegrator')
    def test_autonomous_with_torch_backend(self, mock_integrator, autonomous_sde_system):
        ...
        # Import torch for this test
        try:
            import torch
            x0 = torch.tensor([1.0, 0.5])
            u_func = lambda t, x: None
            
            # Note: Using mock, so result will be numpy
            result = integrator.integrate(
                x0=x0,
                u_func=u_func,
                t_span=(0.0, 1.0)
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffraxSDEIntegrator')
    def test_autonomous_with_jax_backend(self, mock_integrator, autonomous_sde_system):
...
class TestPureDiffusionProcesses:
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_pure_diffusion_creation(self, mock_integrator, pure_diffusion_system):
        """Test factory creates integrator for pure diffusion."""
        mock_integrator.return_value = MockSDEIntegrator(pure_diffusion_system)
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_pure_diffusion_integration(self, mock_integrator, pure_diffusion_system):
        ...
        assert result.success
        # For pure diffusion with zero drift, state should remain near initial
        # (in mock, drift is zero so state changes only slightly)
    
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_brownian_motion_with_additive_noise(self, mock_integrator, pure_diffusion_system):
...
class TestUseCaseHelpers:
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_for_production_defaults(self, mock_integrator, controlled_sde_system):
        """Test for_production() with default settings."""
        mock_integrator.return_value = MockSDEIntegrator(controlled_sde_system)
        
        integrator = SDEIntegratorFactory.for_production(controlled_sde_system)
        
        # Should use Julia by default
        mock_integrator.assert_called_once()
        assert mock_integrator.call_args[1]['backend'] == 'numpy'
    
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_for_production_additive_noise(self, mock_integrator, additive_noise_system):
        """Test for_production() optimizes for additive noise."""
        mock_integrator.return_value = MockSDEIntegrator(additive_noise_system)
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_for_production_diagonal_noise(self, mock_integrator, diagonal_noise_system):
        """Test for_production() optimizes for diagonal noise."""
        mock_integrator.return_value = MockSDEIntegrator(diagonal_noise_system)
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_for_julia(self, mock_integrator, controlled_sde_system):
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffraxSDEIntegrator')
    def test_for_optimization_jax(self, mock_integrator, controlled_sde_system):
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.TorchSDEIntegrator')
    def test_for_neural_sde(self, mock_integrator, controlled_sde_system):
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_for_monte_carlo(self, mock_integrator, controlled_sde_system):
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_for_simple_simulation(self, mock_integrator, controlled_sde_system):
...
class TestAutoSelection:
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffraxSDEIntegrator')
    def test_auto_prefers_jax(self, mock_integrator, controlled_sde_system):
        ...
        with patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.jax'):
            ...
            # Should prefer JAX
            assert mock_integrator.called
    
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.TorchSDEIntegrator')
    def test_auto_falls_back_to_torch(self, mock_integrator, controlled_sde_system):
        """Test auto() falls back to PyTorch."""
        mock_integrator.return_value = MockSDEIntegrator(controlled_sde_system)
        
        # Mock JAX as unavailable but torch available
        with patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.jax', side_effect=ImportError):
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_auto_falls_back_to_numpy(self, mock_integrator, controlled_sde_system):
        """Test auto() falls back to NumPy/Julia."""
        mock_integrator.return_value = MockSDEIntegrator(controlled_sde_system)
        
        # Mock all advanced backends as unavailable
        with patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.jax', side_effect=ImportError):
            with patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.torch', side_effect=ImportError):
                integrator = SDEIntegratorFactory.auto(controlled_sde_system)
...
class TestUtilityFunctions:
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_get_info_julia_method(self, mock_class):
...
class TestConvenienceFunctions:
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_create_sde_integrator(self, mock_integrator, controlled_sde_system):
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_auto_sde_integrator(self, mock_integrator, controlled_sde_system):
...
class TestOptionsPropagation:
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_dt_propagation(self, mock_integrator, controlled_sde_system):
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_seed_propagation(self, mock_integrator, controlled_sde_system):
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_convergence_type_propagation(self, mock_integrator, controlled_sde_system):
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_custom_options_propagation(self, mock_integrator, controlled_sde_system):
...
class TestEndToEndIntegration:
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_controlled_system_full_workflow(self, mock_integrator, controlled_sde_system):
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_autonomous_system_full_workflow(self, mock_integrator, autonomous_sde_system):
    ...
    @patch('src.systems.base.numerical_integration.stochastic.sde_integrator_factory.DiffEqPySDEIntegrator')
    def test_pure_diffusion_full_workflow(self, mock_integrator, pure_diffusion_system):
