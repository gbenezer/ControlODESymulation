...
from src.systems.base.discretization.stochastic.stochastic_discrete_linearization import (
    StochasticDiscreteLinearization,
)
...
class DiscreteLinearStochasticSystem(DiscreteStochasticSystem):
    ...
    def define_system(
        self, a11=0.9, a12=0.1, a21=-0.1, a22=0.8, b1=0.0, b2=1.0, sigma1=0.1, sigma2=0.05
    ):
...
class TestBasicStochasticLinearization:
    ...
    def test_linearize_discrete_stochastic_linear(self):
        ...
        system = DiscreteLinearStochasticSystem(
            a11=0.9, a12=0.1, a21=-0.1, a22=0.8, b1=0.0, b2=1.0, sigma1=0.1, sigma2=0.05
        )
        lin = StochasticDiscreteLinearization(system)
