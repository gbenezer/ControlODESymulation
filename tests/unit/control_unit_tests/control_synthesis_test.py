...
class TestUnifiedLQRMethod(SynthesisTestCase):
    ...
    def test_design_lqr_discrete_default(self):
        ...
        result = synthesis.design_lqr(self.Ad, self.Bd, self.Q, self.R)
    ...
    def test_design_lqr_discrete_explicit(self):
        ...
        result = synthesis.design_lqr(self.Ad, self.Bd, self.Q, self.R, system_type="discrete")
...
class TestKalmanMethod(SynthesisTestCase):
    ...
    def test_design_kalman_default_discrete(self):
        ...
        result = synthesis.design_kalman(self.Ad, self.C, self.Q_process, self.R_meas)
...
class TestBackendConsistency(SynthesisTestCase):
    ...
    def test_backend_passed_to_kalman(self):
        ...
        with patch("src.control.classical_control_functions.design_kalman_filter") as mock_func:
            ...
            synthesis = ControlSynthesis(backend="numpy")
            synthesis.design_kalman(self.Ad, self.C, self.Q_process, self.R_meas)
    ...
    def test_torch_backend_end_to_end(self):
        ...
        result = synthesis.design_lqr(A_torch, B_torch, Q_torch, R_torch, system_type="continuous")
    ...
    def test_jax_backend_end_to_end(self):
        ...
        result = synthesis.design_lqr(A_jax, B_jax, Q_jax, R_jax, system_type="continuous")
...
class TestDelegation(SynthesisTestCase):
    ...
    def test_no_state_mutation(self):
        ...
        synthesis.design_lqr(self.A_stable, self.B_stable, self.Q, self.R, system_type="continuous")
...
class TestIntegration(SynthesisTestCase):
    ...
    def test_lqr_then_kalman_separately(self):
        ...
        lqr_result = synthesis.design_lqr(self.Ad, self.Bd, self.Q, self.R, system_type="discrete")
    ...
    def test_continuous_vs_discrete_consistency(self):
        ...
        result_d = synthesis.design_lqr(self.Ad, self.Bd, self.Q, self.R, system_type="discrete")
...
class TestErrorPropagation(SynthesisTestCase):
    ...
    def test_kalman_dimension_error_propagates(self):
        ...
        with self.assertRaises(ValueError):
            synthesis.design_kalman(self.Ad, C_wrong, self.Q_process, self.R_meas)  # 2x2
    ...
    def test_riccati_failure_propagates(self):
        ...
        try:
            result = synthesis.design_lqr(A, B, self.Q, self.R, system_type="continuous")
...
class TestInterface(SynthesisTestCase):
    ...
    def test_all_methods_exist(self):
        ...
        for method in required_methods:
            self.assertTrue(hasattr(synthesis, method), f"Missing method: {method}")
            self.assertTrue(callable(getattr(synthesis, method)), f"{method} is not callable")
    ...
    def test_return_types_match_docs(self):
        ...
        kalman_result = synthesis.design_kalman(self.Ad, self.C, self.Q_process, self.R_meas)
